...
class Movies:
    ...
    def list(
        ...
        *,
        ...
        response = self._transport.request(MovieRoutes.LIST.method, MovieRoutes.LIST.url(self._transport.base_url), params=params)
    ...
    def list_quotes(
        ...
        *,
        ...
        params = build_params(limit=limit, page=page, offset=offset, sort=sort)
        response = self._transport.request(endpoint.method, endpoint.url(self._transport.base_url, movie_id=movie_id), params=params)
